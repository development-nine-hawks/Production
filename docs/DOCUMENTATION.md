...
`generate_prng_macro_pattern(width, height, seed, block_size=16)`
...
`add_rgb_perturbations(combined, seed=seed, intensity=25, block_size=16)`
...
**Function**: `test_prng_correlation(captured_gray, reference_gray, block_size=16)`
...
| `BLOCK_SIZE` | 16 | PRNG macro-block size |
